...
jsonFile =spark.read.json("data/2015-03-01-17.json")
#jsonFile.show()
...
# jsonData.select(
#     col('id'),
#     (col('id')<"19000").alias("id_lower_190000")
# )

# jsonData.select(
#     col('id'),
#     (col("actor_id")-(col("actor_id")%2)).alias("actor_id_new")
# )
