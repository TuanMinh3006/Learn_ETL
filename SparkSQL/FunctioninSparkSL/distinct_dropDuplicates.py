...
jsonData.select(col("payload.issue.state")).distinct().selectExpr("count(state) as k").show()
#drop_duplicate neu ko dien thi se drop_duplicate se xoa trung lap ca table